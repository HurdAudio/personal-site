...
const philip_k_dick_awards = require('./routes/philip_k_dick_awards.js');
const pulitzer_prize_for_fictions = require('./routes/pulitzer_prize_for_fictions.js');
...
const spur_awards = require('./routes/spur_awards.js');
const sunburst_awards = require('./routes/sunburst_awards.js');
const this_is_horror_awards = require('./routes/this_is_horror_awards.js');
const thurber_prizes = require('./routes/thurber_prizes.js');
const walter_scott_prizes = require('./routes/walter_scott_prizes.js');
const world_fantasy_awards = require('./routes/world_fantasy_awards.js');
const wonderland_book_awards = require('./routes/wonderland_book_awards.js');
