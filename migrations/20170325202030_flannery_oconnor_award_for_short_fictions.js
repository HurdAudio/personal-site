...
exports.up = function(knex, Promise) {
  return knex.schema.createTable('flannery_oconnor_award_for_short_fictions', function(table) {
...
exports.down = function(knex, Promise) {
  return knex.schema.dropTable('flannery_oconnor_award_for_short_fictions');
};
