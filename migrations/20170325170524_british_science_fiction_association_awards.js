...
exports.up = function(knex, Promise) {
  return knex.schema.createTable('british_science_fiction_association_awards', function(table) {
...
exports.down = function(knex, Promise) {
  return knex.schema.dropTable('british_science_fiction_association_awards');
};
