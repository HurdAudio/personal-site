...
exports.up = function(knex, Promise) {
  return knex.schema.createTable('pen_bellwether_prize_for_socially_engaged_fictions', function(table) {
...
exports.down = function(knex, Promise) {
  return knex.schema.dropTable('pen_bellwether_prize_for_socially_engaged_fictions');
};
