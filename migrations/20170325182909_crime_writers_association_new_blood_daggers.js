...
exports.up = function(knex, Promise) {
  return knex.schema.createTable('crime_writers_association_new_blood_daggers', function(table) {
...
exports.down = function(knex, Promise) {
  return knex.schema.dropTable('crime_writers_association_new_blood_daggers');
};
